...
var biicore = {
	...
	bgMusic: 'beautiful-in-white.mp3'
}
...
window.onload = (event) => {
	setTimeout(function () {
		...
		snowFall.snow(document.getElementsByTagName('body')[0], { image: SNOW_Picture, minSize: 32, maxSize: 40, flakeCount: flakeCount, maxSpeed: 6, minSpeed: 3 });
		showSnow();
	}, 50);
